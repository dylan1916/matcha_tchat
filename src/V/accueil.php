...
<div class="container-fluid">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
                <a href="#" class="navbar-brand" style="color:#424242; font-size: 26px; font-family: 'Secular One', sans-serif; text-decoration: none; font-style: italic;"><img src="https://img.icons8.com/color/32/000000/--tinder.png" class="d-inline-block align-top">TO LOG IN</a>
    ...
    <!-- Modal -->
     <div class="modal fade" id="exampleModalInscription" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          ...
          <!-- ICI J'AI SUPP LA CLASS SUR LE BTN POUR SE CREER UN COMPTE -->
